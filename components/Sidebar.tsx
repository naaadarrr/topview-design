...
const Sidebar: React.FC<SidebarProps> = ({ activeId, onNavigate, onLogoClick }) => {
  return (
    <nav className="w-full lg:w-72 flex-shrink-0 lg:fixed lg:top-0 lg:left-0 lg:h-screen bg-transparent border-b lg:border-b-0 lg:border-r border-white/10 px-10 py-0 z-50">
