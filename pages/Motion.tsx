...
const Motion: React.FC = () => {
  const principles = [
    { title: 'Clear', desc: 'Prioritize clarity and understanding over aesthetics.', color: 'bg-blue-500' },
    { title: 'Fast', desc: 'Optimized for speed and immediate response.', color: 'bg-emerald-500' },
    { title: 'Consistent', desc: 'Unified rhythm and behavior across the interface.', color: 'bg-purple-500' },
    { title: 'Minimal', desc: 'Focus on essential movements, avoiding distraction.', color: 'bg-rose-500' },
  ];
    ...
    <div className="max-w-full text-white space-y-32 pb-40">
      ...
      <section className="fade-in">
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-20 w-full">
          ...
          <p className="max-w-md text-[20px] leading-[26px] font-sans text-white mt-4 md:mt-10 font-normal">
            Motion clarifies, not decorates: fewer, faster, consistent—only for feedback and understanding.
          </p>
        </div>
      </section>
      ...
      <section className="fade-in pt-20" style={{ animationDelay: '0.2s' }}>
        <div className="flex flex-col gap-4 mb-16">
          <h2 className="text-[44px] md:text-[56px] leading-[1.1] md:leading-[72px] font-heading tracking-tight">Motion Spec & Implementation</h2>
          <p className="max-w-md text-[14px] leading-[20px] font-sans text-white/60 mt-4 md:mt-10 font-normal">
            Technical specifications and implementation guidelines for developers.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="group relative bg-neutral-900 border border-white/5 rounded-[10px] p-8 transition-all duration-500 overflow-hidden hover:bg-neutral-800">
            ...
            <h4 className="text-xl font-bold mb-2 font-sans group-hover:text-[#3643FF] transition-colors text-white">Hero Animation Spec</h4>
            <p className="text-sm text-neutral-500 font-sans mb-8">Detailed entrance sequence, GSAP parameters, and easing functions for the hero section.</p>
